...
const Refresh: React.FC = () => {
  ...
  const addNewItem = () => {
    ...
    const item: Item = { id: Date.now(), name: newItem.name, price: parseFloat(newItem.price) };
    setItems([...items, item]);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <h1 className="text-2xl font-bold text-gray-800">Refreshment Management</h1>
          <p className="text-gray-600 mt-1">Manage your workplace refreshments</p>
        </div>
      </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3">
                  {items.map(item => (
                    <div 
                      ...
                      {/* Hover Add Effect */}
                      <div className="absolute inset-0 bg-green-600 bg-opacity-0 group-hover:bg-opacity-10 rounded-xl transition-all duration-200 flex items-center justify-center">
                ...
                <div className="mt-6 pt-4 border-t border-gray-100">
                  <div className="flex justify-between text-sm text-gray-600">
                    <span>Price Range: ₹{Math.min(...items.map(i => i.price))} - ₹{Math.max(...items.map(i => i.price))}</span>
                  ...
                  <div key={purchase.id} className="border rounded-lg p-4">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{purchase.timestamp}</p>
                      </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[80vh] overflow-hidden">
            ...
            <div className="bg-green-50 px-6 py-4 border-b">
              <h3 className="text-lg font-semibold text-gray-800">Confirm Your Purchase</h3>
              <p className="text-sm text-gray-600 mt-1">Please review your items before completing the purchase</p>
            </div>
            ...
            <div className="px-6 py-4 max-h-60 overflow-y-auto">
              ...
              <div className="mt-4 pt-4 border-t">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  {cart.reduce((sum, item) => sum + item.quantity, 0)} item{cart.reduce((sum, item) => sum + item.quantity, 0) !== 1 ? 's' : ''} in total
                </p>
              </div>
            </div>
